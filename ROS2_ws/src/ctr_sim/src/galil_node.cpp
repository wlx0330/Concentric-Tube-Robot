...
public:
    ...
    GalilNode::GalilNode() : Node("GalilController")
    {
        ...
        this->motor_init_srv_ = this->create_service<ctr_sim::srv::MotorConnect>("MotorInit", std::bind(&GalilNode::motor_init_callback, this, _1, _2), rmw_qos_profile_services_default, this->srv_callbk_group_);
        this->motor_target_sub_ = this->create_subscription<ctr_sim::msg::MotorPos>("MotorTarget", 10, std::bind(&GalilNode::motor_target_callback, this, _1));
